...
class UpgradeVC: UIViewController {
    ...
    @IBAction func mainBuildingTapped(_ sender: Any) {
        if buildingsLevel.mainBuildingGold <= materials.gold && buildingsLevel.mainBuildingWood <= materials.wood {
    ...
    @IBAction func barracksTapped(_ sender: Any) {
        if buildingsLevel.barracksGold <= materials.gold && buildingsLevel.barracksWood <= materials.wood {
    ...
    @IBAction func stockTapped(_ sender: Any) {
        if buildingsLevel.stockGold <= materials.gold && buildingsLevel.stockWood <= materials.wood {
    ...
    @IBAction func woodTapped(_ sender: Any) {
        if buildingsLevel.woodGold <= materials.gold && buildingsLevel.woodWood <= materials.wood {
    ...
    @IBAction func goldTapped(_ sender: Any) {
        ...
        if buildingsLevel.goldGold <= materials.gold && buildingsLevel.goldWood <= materials.wood {
            ...
            materials.wood -= buildingsLevel.goldGold
